...
import { SpriteModel } from 'src/app/core/models/sprite.model';
...
export class PetAnimationComponent implements OnInit {
  ...
  public chooseAnimation(spriteObj: any): void {
  ...
  public startAnimation(spriteObj: any): void {
    clearInterval(this.setIntervalHandler);
  ...
  public nextSpriteFrame(spriteObj: any): void {
